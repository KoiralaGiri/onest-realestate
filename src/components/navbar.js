        ...
        <div className="navbar-content">
          ...
          <div className={`mobile-menu ${isMenuOpen ? 'active' : ''}`}>
            ...
            <div className="nav-links">
              ...
              <Link to="/buyers" className="nav-link" onClick={() => setIsMenuOpen(false)}>
                Buyers
              </Link>
              <Link to="/sellers" className="nav-link" onClick={() => setIsMenuOpen(false)}>
                Sellers
              </Link>
              <Link to="/communities" className="nav-link" onClick={() => setIsMenuOpen(false)}>
                Communities
              </Link>
            ...
            <div className="mobile-buttons">
              <Link to="/contact" className="contact-button" onClick={() => setIsMenuOpen(false)}>
                <Send size={16} />
                Contact eNest
              </Link>
