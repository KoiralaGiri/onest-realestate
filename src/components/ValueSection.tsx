  ...
  const values = [
    {
      icon: <Flame size={32} />,
      title: 'Audacity',
      description: 'Pushing boundaries and embracing innovation in real estate.'
    },
    {
      ...
      <div className="values-content">
        ...
        >
          <h1 className="values-title">
            <TypingAnimation className='TypeAnimation' text='Redefining How People Find Their Dream Homes' duration={50}/>
          </h1>
        </motion.div>
        ...
        >
          ...
          <p className="values-description">
            Discover the ONEST difference—where exceptional service, 
            community values, and innovative solutions come together to 
            create an experience tailored just for you.
          </p>
